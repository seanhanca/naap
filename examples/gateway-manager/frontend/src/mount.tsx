/**
 * UMD Mount Entry for Gateway Manager Plugin
 *
...
const PLUGIN_GLOBAL_NAME = 'NaapPluginGatewayManager';

export const mount = plugin.mount;
export const unmount = (plugin as any).unmount;
export const getContext = (plugin as any).getContext;
export const metadata = (plugin as any).metadata || { name: 'gatewayManager', version: '1.0.0' };
