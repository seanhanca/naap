/**
 * UMD Mount Entry for Network Analytics Plugin
 *
...
const PLUGIN_GLOBAL_NAME = 'NaapPluginNetworkAnalytics';

export const mount = plugin.mount;
export const unmount = (plugin as any).unmount;
export const getContext = (plugin as any).getContext;
export const metadata = (plugin as any).metadata || { name: 'networkAnalytics', version: '1.0.0' };
