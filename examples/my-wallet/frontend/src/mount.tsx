/**
 * UMD Mount Entry for My Wallet Plugin
 *
...
const PLUGIN_GLOBAL_NAME = 'NaapPluginMyWallet';

export const mount = plugin.mount;
export const unmount = (plugin as any).unmount;
export const getContext = (plugin as any).getContext;
export const metadata = (plugin as any).metadata || { name: 'myWallet', version: '1.0.0' };
