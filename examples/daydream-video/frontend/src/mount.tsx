/**
 * UMD Mount Entry for Daydream Video Plugin
 *
...
const PLUGIN_GLOBAL_NAME = 'NaapPluginDaydreamVideo';

export const mount = plugin.mount;
export const unmount = (plugin as any).unmount;
export const getContext = (plugin as any).getContext;
export const metadata = (plugin as any).metadata || { name: 'daydreamVideo', version: '1.0.0' };
